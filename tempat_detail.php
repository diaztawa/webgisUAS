...
<div class="row">
    <div class="col-md-6">
        <p>Hari lahir: <?=$row->hari_lahir?></p>
        <p>Penghasilan: <?=$row->uang?> Yen</p>
    ...
    <div class="col-md-6">
        <p>
            <a href="?m=tempat_list" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-chevron-left"></span> Lihat lokasi kuda lain</a>
        </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a style="position: center;" class="thumbnail" href="#" data-image-id="" data-toggle="modal"data-title="<?=$r->nama_galeri?>" data-caption="<?=strip_tags($r->ket_galeri)?>" data-image="assets/images/galeri/<?=$r->gambar?>" data-target="#image-gallery">
