...
require_once'functions.php';
    ...
    if($mod=='tempat_tambah'){
        ...
        if($nama_kuda=='' || $hari_lahir=='' || $nama_tempat=='' || $gambar['name']=='' || $lat=='' || $lng=='' || $lokasi=='' || $keterangan=='') 
            ...
            $db->query("INSERT INTO tb_tempat (nama_kuda, hari_lahir, kelamin, uang, nama_tempat, gambar, lat, lng, lokasi, ketersediaan, keterangan) 
                    VALUES ('$nama_kuda', '$hari_lahir', '$kelamin', '$uang', '$nama_tempat', '$file_name', '$lat', '$lng', '$lokasi', '$ketersediaan', '$keterangan')");                       
        ...
        print_msg("Field bertanda * tidak boleh kosong!");
            ...
            $db->query("UPDATE tb_tempat SET nama_kuda='$nama_kuda' hari_lahir='$hari_lahir' kelamin='$kelamin' uang='$uang' nama_tempat='$nama_tempat' $sql_gambar , lat='$lat', lng='$lng', lokasi='$lokasi', ketersediaan='$ketersediaan' keterangan='$keterangan' WHERE id_tempat='$_GET[ID]'");
            redirect_js("index.php?m=tempat");
        }    
